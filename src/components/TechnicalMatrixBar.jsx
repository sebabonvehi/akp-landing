const TechnicalMatrixBar = () => {
  return (
    <section className="mt-16 w-full border-y border-outline-variant/30 bg-surface-container-lowest px-margin-mobile py-1 font-Geist text-label-sm uppercase tracking-widest text-on-surface-variant md:mt-20 md:px-margin">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-x-4 gap-y-1">
        ...
        <div className="flex items-center gap-2">
          <span className="hidden text-outline md:inline">Protocolo e-LAB &amp; VITA 3D-Master</span>
