const Hero = () => {
  return (
    <section className="relative w-full bg-surface px-6 pt-16 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8">
        ...
        <div className="flex-1 flex flex-col items-start max-w-2xl">
          ...
          <h1 className="text-5xl font-EB_Garamond text-on-surface mb-5 leading-tight">
            Consulte con Nuestros <span className="italic text-primary">Maestros Ceramistas</span> y Especialistas CAD/CAM.
          </h1>
          <p className="text-lg font-Hanken_Grotesk text-on-surface-variant mb-6">
          ...
          <div className="flex flex-wrap items-center gap-3 mb-6 w-full">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-primary hover:bg-primary-container text-on-primary font-Geist text-xs uppercase px-5 py-2 rounded shadow-lg transition-all hover:shadow-[0_0_24px_rgba(242,202,80,0.35)]"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-surface-container-high hover:bg-surface-bright text-on-surface font-Geist text-xs uppercase px-5 py-2 rounded transition-all"
            >
          ...
          {/* Metric Badges */}
          <div className="grid grid-cols-3 gap-2 w-full pt-4 bg-surface-container-low p-2 rounded">
