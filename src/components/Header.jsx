      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 md:h-20">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="hidden flex-col lg:flex">
            <span className="font-Geist text-label-md font-semibold uppercase tracking-widest text-primary">
              AKP Digital Dental Lab
            </span>
            <span className="font-Geist text-label-sm font-medium uppercase tracking-wider text-on-surface">
        ...
        <nav className="hidden items-center gap-4 md:flex">
          <a
            className="px-2 py-1 font-Geist text-label-sm font-medium uppercase tracking-wider text-on-surface transition-colors hover:text-primary"
