  ...
  return (
    <div className="flex h-full flex-col justify-between rounded-lg bg-surface-container-low p-6 transition-colors hover:bg-surface-container">
      <div className="flex flex-col gap-2">
        ...
        <span className="font-label text-label-sm font-semibold tracking-wider text-outline uppercase">
          {badgeText}
        </span>
      ...
      <div className="mt-6 flex items-center gap-1 font-label text-label-sm font-semibold tracking-wider text-secondary uppercase">
        <span>{linkText}</span>
