...
const SpecialtyPills = () => {
  ...
  return (
    <div className="flex flex-col gap-2">
      <span className="font-Geist text-label-sm font-medium uppercase tracking-wider text-primary">
      ...
      <div className="flex flex-wrap gap-1.5">
        {pills.map((label, index) => (
          <button
            ...
            className={`rounded-sm px-3 py-1 font-Geist text-label-sm font-medium uppercase tracking-wider transition-colors ${
              selectedPill === index
