...
const eyebrow =
  'block font-label text-label-sm font-semibold uppercase tracking-wider text-primary';
      ...
      >
        <div className="mx-auto max-w-7xl">
          <div className="mb-6 text-center md:text-left">
            ...
            <h2 className="font-serif text-headline-sm text-on-surface md:text-headline-md">
              Formulario de Valoración Directa por Email
            </h2>
            <p className="mx-auto max-w-2xl font-sans text-body-md text-on-surface-variant md:mx-0">
          ...
          <div className="grid grid-cols-1 items-start gap-6 lg:grid-cols-12">
            ...
            <aside className="flex flex-col gap-4 lg:col-span-4">
              ...
              <div className="relative rounded-lg bg-surface-container p-4">
                ...
                <h3 className="mb-4 font-serif text-headline-sm text-on-surface">
                ...
                <div className="flex flex-col gap-1">
                  <div className="rounded-sm bg-surface-container-lowest p-2">
                    <span className="block font-label text-label-sm tracking-wider text-outline uppercase">
                      Consultas generales &amp; presupuestos:
                    </span>
                    <a
                      className="mt-0.5 inline-flex items-center gap-2 font-label text-xs font-medium text-primary hover:underline"
                ...
                <div className="mt-4">
                  <span className="block font-label text-label-sm font-semibold tracking-wider text-on-surface uppercase">
                    Horario equipo ceramista
                  </span>
                  <div className="mt-1 flex items-center gap-2 font-sans text-sm text-on-surface-variant">
              ...
              <div className="rounded-lg bg-surface-container p-4">
                <div className="mb-2 flex items-center gap-2 font-label text-label-sm font-semibold tracking-wider text-primary uppercase">
                  <span className="material-symbols-outlined text-[18px]">drive_folder_upload</span>
                  ¿Archivos STL o PLY voluminosos?
                </div>
                <p className="mb-2 font-sans text-body-sm text-on-surface-variant">
                ...
                <p className="mt-2.5 font-sans text-body-sm text-outline italic">
